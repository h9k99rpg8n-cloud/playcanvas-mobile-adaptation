...
const trackScene = { scene: { objects: [{ id: 'track-torus', name: 'Pista circular', type: 'torus', position: [0, 0.08, 0], rotation: [90, 0, 0], scale: [6, 6, 0.18] }], ui: [] } };
...
export const TEMPLATES = [
  ...
  { ...meta, id: 'track-template', name: 'Carreras', icon: '○', description: 'Pista simple creada con Toroide.', installed: false, data: trackScene }
];
